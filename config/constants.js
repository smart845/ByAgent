export const CONFIG = {
  ...
  UI: { moversLimit: 200, setupsMinNotional24h: 2e6, anomaliesZScore: 3, wsReconnectMs: 4500, oiInterval: '5min', agentPeriodSec: 5 }
};
export const AppState = { currentSymbol: 'BTCUSDT', favorites: new Set(), alerts: new Map(), ws: null, wsConnected: false, realTime: new Map(), lastSnapshots: { movers: [], setups: [], anomalies: [] } };